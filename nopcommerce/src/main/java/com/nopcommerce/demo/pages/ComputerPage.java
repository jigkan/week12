...
public class ComputerPage extends Utility {
    ...
    public String discendingtext() {Reporter.log("discending order text" + discendingorder.toString());
    ...
    public String builtextmethod(){
        Reporter.log("biult text" + builttext.toString());
        return getTextFromElement(builttext);}
    ...
    public String pricemethod(){
        Reporter.log("price text" + price.toString());
    ...
    public String adddto_carttextmethod(){
        Reporter.log("aad to cart text" + addto_cart.toString());
        return getTextFromElement(addto_carttext);}
 ...
 public String shoppingcarmsgmethod(){
     Reporter.log("shopping cart msg text" + shoppingcartmsg.toString());
    ...
    public String totalmethod(){ Reporter.log("total text" + total.toString());
    ...
    public String welcometextmethod(){
        Reporter.log("get welcome text" + welcometext2.toString());
        return getTextFromElement(welcometext2); }
...
//2.29 Click on “CONTINUE”
    ...
    public String paymenttextmethod(){
        Reporter.log("payment text" + paymenttext.toString());
        return getTextFromElement(paymenttext);}
    //            2.32 Verify “Shipping Method” is “Next Day Air”
    By shippingtext=By.xpath("//div[@class='cart-footer']/div/div[1]/table/tbody/tr[2]/td/span[1]");
    public String shippingtextmethod(){
        Reporter.log("shipping text" + shippingtext.toString());
    ...
    public String totaltextingmethod(){
        Reporter.log("total text" + totaltexting.toString());
        return getTextFromElement(totaltexting);}
    ...
    public String thanktextmethod(){
        Reporter.log("thank text" + thanktext.toString());
        return getTextFromElement(thanktext);}
    //        //            2.36 Verify the message “Your order has been successfully processed!”
    By successtext=By.xpath("//div[@class='center-1']/div[1]/div[2]/div[1]/div[1]");
    public String successtextmethod(){
    ...
    public String welcomestoretextmethod(){
        Reporter.log("get welcome text" + welcomestoretext.toString());
